...
if __name__ == '__main__':
    ...
    parser.add_argument('--rl_method', 
        choices=['dqn', 'pg', 'ac', 'a2c', 'a3c'], default='ac')#
    ...
    for stock_code in args.stock_code:
        # set network
        value_network_path = os.path.join(settings.BASE_DIR, 'models/value/{}.h5'.format(stock_code))
        policy_network_path = os.path.join(settings.BASE_DIR, 'models/policy/{}.h5'.format(stock_code))
