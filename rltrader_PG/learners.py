...
class ReinforcementLearner:
    ...
    def save_models(self, num_epoch):
        if self.value_network is not None and \
                self.value_network_path is not None:
            self.value_network.save_model(self.value_network_path + '_{}.h5'.format(num_epoch))
            print(self.value_network_path + '_{}.h5'.format(num_epoch))
        if self.policy_network is not None and \
                self.policy_network_path is not None:
            self.policy_network.save_model(self.policy_network_path + '_{}.h5'.format(num_epoch))
            print(self.policy_network_path + '_{}.h5'.format(num_epoch))
