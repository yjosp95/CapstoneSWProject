import numpy as np
import utils
from utility.networks import OrnsteinUhlenbeckProcess
...
class Agent:
    ...
    def act(self, action, confidence):
        #print(action)
        if not self.validate_action(action) or confidence < .5:
